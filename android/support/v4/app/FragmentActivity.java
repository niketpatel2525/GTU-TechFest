...
public class FragmentActivity extends Activity {
    ...
    class C00512 implements FragmentContainer {
        C00512() {
        }
    ...
    public void dump(String prefix, FileDescriptor fd, PrintWriter writer, String[] args) {
        ...
        if (VERSION.SDK_INT >= HONEYCOMB) {
            ...
            innerPrefix = prefix + EventSloganClass.urbanista_slogan;
        ...
        if (this.mLoaderManager != null) {
            ...
            writer.println(":");
            this.mLoaderManager.dump(prefix + EventSloganClass.urbanista_slogan, fd, writer, args);
        }
        this.mFragments.dump(prefix, fd, writer, args);
        writer.print(prefix);
        writer.println("View Hierarchy:");
        dumpViewHierarchy(prefix + EventSloganClass.urbanista_slogan, writer, getWindow().getDecorView());
    }
    ...
    private static String viewToString(View view) {
        ...
        if (id != -1) {
            ...
            if (!(id == 0 || r == null)) {
                ...
                out.append(WorkshopSlogan.tallbuilding_slogan_work);
                out.append(pkgname);
                out.append(":");
                out.append(typename);
                out.append("/");
    ...
    private void dumpViewHierarchy(String prefix, PrintWriter writer, View view) {
        ...
        if (view instanceof ViewGroup) {
            ...
            if (N > 0) {
                prefix = prefix + EventSloganClass.urbanista_slogan;
