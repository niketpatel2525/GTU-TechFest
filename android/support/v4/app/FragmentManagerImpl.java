...
final class FragmentManagerImpl extends FragmentManager {
    ...
    private void throwException(RuntimeException ex) {
        ...
        if (this.mActivity != null) {
            try {
                this.mActivity.dump(EventSloganClass.urbanista_slogan, null, pw, new String[0]);
            } catch (Exception e) {
                Log.e(TAG, "Failed dumping state", e);
            }
        } else {
            try {
                dump(EventSloganClass.urbanista_slogan, null, pw, new String[0]);
            } catch (Exception e2) {
    ...
    public void dump(String prefix, FileDescriptor fd, PrintWriter writer, String[] args) {
        int N;
        int i;
        String innerPrefix = prefix + EventProblem.technathon_Desc;
                ...
                if (fms.mBackStack != null) {
                    ...
                    for (i = 0; i < fms.mBackStack.length; i += ANIM_STYLE_OPEN_ENTER) {
                        ...
                        if (DEBUG) {
                            ...
                            bse.dump(EventSloganClass.urbanista_slogan, new PrintWriter(new LogWriter(TAG)), HONEYCOMB);
                        }
