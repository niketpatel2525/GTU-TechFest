...
public class Fragment implements ComponentCallbacks, OnCreateContextMenuListener {
    ...
    class C00501 implements FragmentContainer {
        C00501() {
        }
    ...
    public String toString() {
        ...
        if (this.mTag != null) {
            sb.append(WorkshopSlogan.tallbuilding_slogan_work);
            sb.append(this.mTag);
        }
        sb.append('}');
        return sb.toString();
    ...
    public void dump(String prefix, FileDescriptor fd, PrintWriter writer, String[] args) {
        ...
        if (this.mChildFragmentManager != null) {
            ...
            this.mChildFragmentManager.dump(prefix + EventSloganClass.urbanista_slogan, fd, writer, args);
        }
    }
    ...
    void instantiateChildFragmentManager() {
        ...
        this.mChildFragmentManager.attachActivity(this.mActivity, new C00501(), this);
    }
